...
function updateText() {
  ...
  if (window.innerWidth <= 500 ) {
    ...
    textElement.textContent = "Year-to-Date contibution" ;
  }
}
...
document
  .getElementById("Dash")
  .addEventListener("click", () => showSection(centerSection));
document
  .getElementById("static")
  .addEventListener("click", () => showSection(rightSection));
document
  .getElementById("profile")
  .addEventListener("click", () => showSection(leftSection));
...
if (window.innerWidth <= 500) {
  document
    ...
    .addEventListener("click", handleCrossIconClick);
}
...
function updateCircleAttributes() {
  ...
  const phone1Cx = screenWidth <= 375 ? 48 : 70;
  const phone1dCy = screenWidth <= 375 ? 56 : 70;
  const phone1R = screenWidth <= 375 ? 44 : 50;
...
*/
// Function to update the value and animate the slider
// const inputId = document.getElementById('employeeInput');
// const spanId = document.getElementById('percentageValue');
// function updateValues(inputId, spanId) {
...
// Event listener for the employee input range
document.getElementById('employeeInput').addEventListener('input', function() {
  updateValues('employeeInput', 'percentageValue');
});

// Event listener for the age input range
document.getElementById('ageInput').addEventListener('input', function() {
  updateValues('ageInput', 'ageValue');
});
...
function changeStyles() {
  ...
  document.querySelector(".contribution .rate .text").style.marginRight =
    "156px";
  ...
  document.querySelector(".contribution .employer .text").style.marginRight =
    "107px";
  document.querySelector(".contribution .employer .text").style.fontWeight =
    "bold";
  document.querySelector(".contribution .employer .text").style.fontSize =
    "12px";

  // Modify styles for .contribution .employer .per
  document.querySelector(".contribution .employer .per").style.fontWeight =
    "bold";
  document.querySelector(".contribution .employer .per").style.fontSize =
    "14px";
